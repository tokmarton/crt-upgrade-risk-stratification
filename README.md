...
<div align="center"><i><b>Figure 1</b> Patient similarity network created using topological data analysis (A) and the Kaplan-Meier curves depicting the survival of the three risk groups (B)</i></div>
...
<div align="center"><i><b>Figure 2</b> Kaplan-Meier curves depicting the survival of the three risk groups in the external dataset(B)</i></div>
